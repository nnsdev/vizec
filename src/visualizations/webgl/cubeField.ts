...
const COLOR_SCHEMES: Record<string, { primary: number; secondary: number; accent: number }> = {
  ...
  darkTechno: { primary: 0x4a00e0, secondary: 0x8e2de2, accent: 0x1a1a2e },
  neon: { primary: 0x39ff14, secondary: 0xff073a, accent: 0xffff00 },
  fire: { primary: 0xff4500, secondary: 0xffd700, accent: 0xff6600 },
  ice: { primary: 0x00bfff, secondary: 0xe0ffff, accent: 0x87ceeb },
  acid: { primary: 0xadff2f, secondary: 0x00ff00, accent: 0x7fff00 },
  monochrome: { primary: 0xffffff, secondary: 0x888888, accent: 0xcccccc },
  purpleHaze: { primary: 0x8b00ff, secondary: 0xff1493, accent: 0x9400d3 },
  sunset: { primary: 0xff6b6b, secondary: 0xfeca57, accent: 0xff9f43 },
  ocean: { primary: 0x0077be, secondary: 0x00d4aa, accent: 0x00b4d8 },
  toxic: { primary: 0x00ff41, secondary: 0x0aff0a, accent: 0x39ff14 },
  bloodMoon: { primary: 0x8b0000, secondary: 0xff4500, accent: 0xdc143c },
  synthwave: { primary: 0xff00ff, secondary: 0x00ffff, accent: 0xff00aa },
  golden: { primary: 0xffd700, secondary: 0xff8c00, accent: 0xffb347 },
};
